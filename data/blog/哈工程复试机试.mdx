...
tags: ['考研']
draft: false
images: ['/static/images/blog/covers/cover-exam.png']
summary: '本文分享多个编程题及C++代码，含求三位水仙花数、[1,n)素数之和、[m,n)非对称素数及和、统计负数个数与正数均值比较等。通过题目描述与代码实现，展示数论判断、数据统计等算法应用，为相关学习提供参考。'
---
