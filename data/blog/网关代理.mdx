...
summary: '拓扑图如下： 安卓手机充当旁路网关 - Mac、Linux使用clash的TUN模式并开启ip转发 - Linux开启ip转发：sysctl -w net.ipv4.ipforward=1 - Mac开启ip转发：sysctl -w net.inet.ip.forwarding=1 > Mac系统也可以直接使用clashX Pro的增强模式实现 - ...'
---
