...
title: 'new bing重定向问题'
date: '2023-05-12'
tags: ['路由器', 'OpenWrt', 'Bing']
draft: false
images: ['/static/images/blog/covers/cover-network.png']
summary: '本文介绍解决New Bing Chat AI访问卡顿或无法打开的方案：通过修改hosts文件（含指定IP与域名映射）、OpenWrt配置额外hosts及Passwall规则，配合Chrome解锁插件，调整Bing URL与国家设置，重启后即可流畅使用。'
---
