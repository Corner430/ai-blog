...
summary: '文章分享Markdown中用HTML语法优化排版的方法，包括<u>标签加下划线，<font>标签设字体颜色与大小，表格<td>属性添背景色。指出Typora与Hexo底纹实现差异，助用户突破限制丰富博客内容。'
---

### 1\. 添加下划线

利用`<u>我有下划线</u>`即可，效果：我有下划线.

### 2\. 添加底纹

如果是在Typora中，直接在内容的两侧各加两个等号即可。然而这种方法在hexo博客当中失效了。
...
- 背景色
  ...
  <table>
    <tr>
      <td bgcolor="#FF00FF">背景色的设置是按照十六进制颜色值：#7FFFD4</td>
    </tr>
  </table>
  <table>
    <tr>
