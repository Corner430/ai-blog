...
summary: '本文介绍科学上网节点测速工具与方法，涵盖单节点测速（含speedtest及无广告版）、全节点测速（如stairspeedtest-reborn）、nodesCatch V2.0全自动一键工具及v2ray测速功能，附参考链接与谷歌节点池搜索指引。'
---
...
[google 搜索节点池](https://www.google.com.hk/search?q=inurl:clash/proxies)
