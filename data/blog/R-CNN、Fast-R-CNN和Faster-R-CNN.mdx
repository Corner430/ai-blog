...
summary: 'R-CNN、Fast R-CNN与Faster R-CNN是目标检测里程碑。R-CNN用Selective Search选候选区、预训练CNN提特征+SVM分类存冗余；Fast R-CNN整图输入CNN+RoI pooling提效；Faster R-CNN以RPN生成候选区提准，促检测发展，Faster R-CNN成主流。'
---
