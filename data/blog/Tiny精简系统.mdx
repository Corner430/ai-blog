...
summary: '文章介绍Tiny10/Tiny11精简系统并提供下载地址，Tiny11可缩至约8GB、2GB RAM运行良好。Tiny含四版Win11 beta（Beta2或优于Beta1）。另推荐AtlasOS、ReviOS等游戏优化类精简系统。'
---
...
Tiny10 需要启动**window update**相关服务才可以下载中文语言包
