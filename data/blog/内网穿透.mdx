...
summary: '本文介绍两种内网穿透方案：frp与Zerotier。frp详述服务端frps.ini、客户端frpc.ini配置示例、执行结果及Windows/Linux开机自启动方法；Zerotier涵盖安装、Moon部署（Docker镜像）、路由器配置等步骤，附具体操作命令，助力实现内网访问。'
---
...
- 访问 [http://ip:3443](http://ip:3443/) 进行配置，初始账号密码为 admin/password
