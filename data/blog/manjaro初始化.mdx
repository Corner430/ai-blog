...
title: 'manjaro初始化'
date: '2023-05-08'
tags: ['Linux', 'Manjaro', 'Arch']
draft: false
images: ['/static/images/blog/covers/cover-linux.png']
summary: '本文提供Manjaro系统实用配置指南，涵盖系统更新、镜像源（含清华大学源）设置、输入法与常用软件（vim、yay、docker等）安装，及deb转pacman、N卡驱动安装方法。同时整理pacman命令集、桌面美化资源链接，助力高效使用Manjaro。'
---
